                ...
                <div class="col-xl-4">
                    ...
                    <div class="card-box">
                        ...
                        <div class="panel-body">
                            <p class="text-muted font-13">{{$user->profile->bio}}</p>
                            <hr>
                            <div class="text-left">
                                <p class="text-muted font-13"><strong>Full Name :</strong> <span class="m-l-15">{{$user->name}} {{$user->surname}}</span></p>
                                <p class="text-muted font-13"><strong>Mobile :</strong><span class="m-l-15">{{$user->profile->number}}</span></p>
                                <p class="text-muted font-13"><strong>Email :</strong> <span
                                        class="m-l-15">{{$user->email}}</span></p>
                                <p class="text-muted font-13"><strong>Mosha :</strong> <span class="m-l-15">{{$user->profile->age}}
                                    </span></p>
                                ...
                                <p class="text-muted font-13"><strong>Location :</strong> <span
                                        class="m-l-15">{{$user->profile->location}}</span></p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="card-box tilebox-one"><i class="icon-layers float-right text-muted"></i>
                                ...
                                <h2 class="" data-plugin="counterup">{{$user->profile->grade}}</h2><span
                        ...
                        <div class="col-sm-4">
                            <div class="card-box tilebox-one"><i class="icon-paypal float-right text-muted"></i>
                                ...
                                <h2 class=""><span data-plugin="counterup">{{$user->profile->experience}}</</span></h2>
                            </div>
                        </div>
                        <!-- end col -->
                        <div class="col-sm-4">
                            <div class="card-box tilebox-one"><i class="icon-rocket float-right text-muted"></i>
                                ...
                                <h2 class="" data-plugin="counterup">{{$user->profile->projects}}</</h2>
                            </div>
                        </div>
                        <!-- end col -->
                    </div>
