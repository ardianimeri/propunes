...
.form-select:focus{
    ...
    box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px rgb(158, 202, 144);
      ...
      <div class="signup">
          <h1 class="text-center">Krijo llogari</h1>
          ...
          <form class="needs-validation" method="POST" action="{{route('users.create)}}">
            ...
            <div class="form-group">
              ...
              <select name="role" class="form-select" name ="dropdown">
                      <option value='punedhenes' > Punedhenes </option>
                      <option value='punekerkues'> Punekerkues </option>
                </select>
              </div>
            <input class="btn btn-success w-100" type="submit" value="Regjistrohu">
            <div class="login-signup">
              <span class="text">Keni llogari?</span>
              <a href="../LAB1/login.html" class="text signup-login">Kyçu</a> 
          </div>
          </form>
      </div>
  </body>
